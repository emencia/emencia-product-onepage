...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TwentyTwenty'
        db.create_table(u'cmsplugin_twentytwenty', (
            ...
            ('left_legend', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('right_legend', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('description', self.gf('djangocms_text_ckeditor.fields.HTMLField')()),
        ))
        db.send_create_signal(u'parrot_product', ['TwentyTwenty'])


    def backwards(self, orm):
        # Deleting model 'TwentyTwenty'
        db.delete_table(u'cmsplugin_twentytwenty')
