...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_subscribe', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('htmlid', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('message', self.gf('djangocms_text_ckeditor.fields.HTMLField')()),
            ('subscribe_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mcrm.Category'])),
        ))
        db.send_create_signal(u'parrot_product', ['Subscribe'])


    def backwards(self, orm):
        # Deleting model 'Subscribe'
        db.delete_table(u'cmsplugin_subscribe')
