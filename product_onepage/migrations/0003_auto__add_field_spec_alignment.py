...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spec.alignment'
        db.add_column(u'cmsplugin_spec', 'alignment',
                      self.gf('django.db.models.fields.CharField')(default='left', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spec.alignment'
        db.delete_column(u'cmsplugin_spec', 'alignment')
